 ...
 *
 * Changes from 2.1.197 (for 2.1.209):
 * - The null-return guard is now brace-wrapped: `if(!X&&!Y){return null}`
 *   instead of `if(!X&&!Y)return null;`. The find pattern now tolerates the
 *   optional braces and trailing semicolon. Replacement is unchanged.
 *
 * Usage:
