...
//   2.1.209 form: ,currentDate:`Today's date is ${A3e()}.`
...
//
// 2.1.209 change: currentDate flipped from a call form (`Fn(Fn())`) to a
// template literal (`` `Today's date is ${Fn()}.` ``). Match the literal.
