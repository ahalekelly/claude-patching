...
// 2.1.186 (JSX runtime): `REACT.default.createElement(C,props,child)` became
// `RUNTIME.jsx(C,{...props,children:child})`, and the memo-cache array is now
// `t[N]` (generalized to any identifier). The wrapper is preceded by an extra
// `let f=p;` (text source assignment) that we leave untouched — the match
// begins at the guard.
const wrapperPattern = new RegExp(
  ...
  // if(t[N]!==X||t[N]!==TS||t[N]!==BRIEF) W_VAR=RUNTIME.jsx(VYF,{text:X,useBriefLayout:BRIEF,timestamp:TS}),t[N]=X,t[N]=TS,t[N]=BRIEF,t[N]=W_VAR;else W_VAR=t[N];
  // New groups: 11=textSrc(X), 12=runtime, 13=vyf.
